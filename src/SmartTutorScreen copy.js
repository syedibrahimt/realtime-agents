...
// import demo from "../../demo/problem1.json";
import {
  Time,
  MicrophoneFilled,
  Minimize,
...
// import KNOM_FILE from "../../animations/knoknomadix_ai.riv";
const KNOM_FILE = require("../../animations/knomadix_ai.riv"); // place the file in public folder or import
...
function SmartTutorScreen(props) {
  ...
  // // Replace first occurrence of highlight with a span-wrapped version
  // const highlightedTextQues = text.replace(
  //   highlightQues,
  //   `<span style="font-weight: bolder;  text-decoration: underline;
  // text-decoration-color: #f90e12;
  ...
  // function renderHighLightText(updatedText) {
  //   console.log("updatedText", updatedText);
  //   let highlightedTextArray = `<span></span>`;
  //   if (updatedText && highlightArray[currentStepIndex - 2]) {
  //     highlightedTextArray = updatedText.replace(
  //       highlightArray[currentStepIndex - 2],
  //       `<span style="font-weight: bolder;  text-decoration: underline;
  //   text-decoration-color: #f90e12;
  //   text-decoration-thickness: 4px;
  //   text-underline-offset: 4px;">${highlightArray[currentStepIndex - 2]}</span>`
  //     );
  //   } else {
  //     highlightedTextArray = `<span>15</span>`;
  //   }
  ...
  //     <div className="steps-area">
  //       <div className="notes-stpes-cont">
  //         {/* <p className="notes-stpes-desc"> {demo.problem}</p> */}
  //         {currentStepIndex === 1 ? (
  //           <p
  //             className="notes-updated-exp"
  //             dangerouslySetInnerHTML={{ __html: highlightedTextQues }}
  ...
  //             const updatedExpression = String(
  //               step?.notes?.UpdatedExpression ?? ""
  //             );

  //             return (
  //               <div className="notes-stpes-cont" key={idx}>
  //                 {currentStepIndex - 1 === idx ? (
  //                   <TypingText text={updatedExpression} speed={80} />
  //                 ) : currentStepIndex - 2 === idx ? (
  //                   <p
  //                     className="notes-updated-exp"
  //                     dangerouslySetInnerHTML={{
  //                       __html: renderHighLightText(updatedExpression),
  //                     }}
  //                   />
  //                 ) : (
  //                   <p className="notes-updated-exp">{updatedExpression}</p>
